...
**Detector catalog lives in `subagents/reviewer-authz.md` — this skill does not re-list it**, so copies cannot drift.

Read `subagents/reviewer-authz.md`, then run its Phase 1–4 workflow inline over
Phase 1 scope, producing same report. Never delegate.

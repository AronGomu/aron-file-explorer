...
Linux extracted-package runtime checks are separate from browser event fixtures; neither proves OS installation, macOS, Windows, release builds, or updater behavior.
